...
```{r, echo=FALSE}
ggplot(cob_metro_lab, aes(x = nsw_lhd_name, y = prop, fill = origin)) +
  geom_col(width = 0.5) +
  geom_text(aes(label = label),
            position = position_stack(vjust = 0.5),
            size = 3, lineheight = 0.9, color = "black") +
  ...
  labs(x = NULL, y = "Proportion",
       fill = NULL,
       title = "Australia vs Overseas — Proportion by LHD (2021)") +
  theme_minimal(base_size = 12) +
  theme(axis.text.x = element_text(),
        legend.position = "bottom")
```
...
```{r, echo=FALSE}
ggplot(lang_metro_lab, aes(x = nsw_lhd_name, y = prop, fill = origin)) +
  geom_col(width = 0.5) +
  geom_text(aes(label = label),
            position = position_stack(vjust = 0.5),
            size = 3, lineheight = 0.9, color = "black") +
  ...
  labs(x = NULL, y = "Proportion",
       fill = NULL,
       title = "English vs Non-English Speaking at Home — Proportion by LHD (2021)") +
  theme_minimal(base_size = 12) +
  theme(axis.text.x = element_text(),
        legend.position = "bottom")
```
