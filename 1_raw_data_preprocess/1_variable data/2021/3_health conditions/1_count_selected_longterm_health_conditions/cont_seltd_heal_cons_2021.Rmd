...
all_lines <- readLines("cont_seltd_heal_cons_raw_2021.csv")
length(all_lines) 
head(all_lines, 11)
tail(all_lines, 9)
```
...
temp_file <- "cont_seltd_heal_cons_temp_2021.csv"
...
write_csv(cont_seltd_heal_cons_2021, "cont_seltd_heal_cons_nsw_2021.csv")
```
