...
# ---- Housing Suitability ----
housing_suit_count <- c("overcrowded", "high_crowded", "not_overcrowded")
housing_suit_prop <- c("prop_overcrowded", "prop_high_crowded", "prop_not_overcrowded")
...
p_income_count_metro <- facet_sa2_maps(
  map_sf      = map_metro_2021,
  vars        = income_count,
  title       = "Personal Income — Counts by SA2 (NSW Metropolitan LHDs, 2021)",
  mode        = "metro",
  lga_sf      = lga_metro_clip_2021,
  lhd_sf      = lhd_metro_clip_2021,
  bbox        = bbox,
...
p_income_prop_metro <- facet_sa2_maps(
  map_sf      = map_metro_2021,
  vars        = income_prop,
  title       = "Personal Income — Proportions by SA2 (NSW Metropolitan LHDs, 2021)",
  mode        = "metro",
  lga_sf      = lga_metro_clip_2021,
  lhd_sf      = lhd_metro_clip_2021,
  bbox        = bbox,
...
p_housing_type_count_metro <- facet_sa2_maps(
  map_sf      = map_metro_2021,
  vars        = housing_type_count,
  title       = "Housing Type — Counts by SA2 (NSW Metropolitan LHDs, 2021)",
  mode        = "metro",
  lga_sf      = lga_metro_clip_2021,
  lhd_sf      = lhd_metro_clip_2021,
  bbox        = bbox,
...
p_housing_type_prop_metro <- facet_sa2_maps(
  map_sf      = map_metro_2021,
  vars        = housing_type_prop,
  title       = "Housing Type — Proportions by SA2 (NSW Metropolitan LHDs, 2021)",
  mode        = "metro",
  lga_sf      = lga_metro_clip_2021,
  lhd_sf      = lhd_metro_clip_2021,
  bbox        = bbox,
...
```{r, echo=FALSE}
p_housing_suit_count_wslhd <- facet_sa2_maps(
  map_sf      = map_wslhd_2021,
  vars        = housing_suit_count,
  title       = "Housing Suitability — Counts by SA2 (WSLHD, 2021)",
  mode        = "wslhd",
  lga_sf      = lga_wslhd_2021,
  tag         = "wslhd",
  legend_name = "Count",
...
p_housing_suit_count_wslhd

p_housing_suit_prop_wslhd <- facet_sa2_maps(
  map_sf      = map_wslhd_2021,
  vars        = housing_type_prop,
  title       = "Housing Suitability — Proportions by SA2 (WSLHD, 2021)",
  mode        = "wslhd",
  lga_sf      = lga_wslhd_2021,
  tag         = "wslhd",
  legend_name = "Proportion",
...
p_housing_suit_prop_wslhd

p_housing_suit_count_metro<- facet_sa2_maps(
  map_sf      = map_metro_2021,
  vars        = housing_suit_count,
  title       = "Housing Type — Counts by SA2 (NSW Metropolitan LHDs, 2021)",
  mode        = "metro",
...
p_housing_suit_count_metro

p_housing_suit_prop_metro <- facet_sa2_maps(
  map_sf      = map_metro_2021,
  vars        = housing_suit_prop,
  title       = "Housing Suitability — Proportions by SA2 (NSW Metropolitan LHDs, 2021)",
  mode        = "metro",
  lga_sf      = lga_metro_clip_2021,
  lhd_sf      = lhd_metro_clip_2021,
  bbox        = bbox,
